...
RESPONSE_ECONOMIST= economist(query=QUERY,llm=LLM1, model_name=MODEL_NAME, role=ROLE_1)
# Reflect on the response from the economist
REFLECYION_RESPONSE_ECONOMIST = reflection(query=RESPONSE_ECONOMIST,llm=LLM1, model_name=MODEL_NAME, reflection_content=REFLECTION_CONTENT1)
# Make the sentence fluent and easy to read
FINAL_RESPONSE = final_reflection(query=REFLECYION_RESPONSE_ECONOMIST,llm=LLM1, model_name=MODEL_NAME, reflection_content=FINAL_REFLECTION_CONTENT)
